...
import AdminClearLayoutButton from "@/components/AdminClearLayoutButton";
    ...
    <>
      ...
      <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          {template.layout && <AdminClearLayoutButton slug={template.slug} />}
          <Link
          ...
          >
            ...
            {template.layout ? "Edit layout" : "Author layout"}
          </Link>
        </div>
      </div>
